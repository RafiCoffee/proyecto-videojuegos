import { deleteVideojuego } from "../services/deleteVideojuego";
import { getVideojuegos } from "../services/getVideojuegos"
import { postVideojuego } from "../services/postVideojuego"
import { updateVideojuego } from "../services/updateVideojuego";
...
export const handleSubmit = ({juego, peticion = -1}) => async (e) => {
    ...
    switch(peticion){
        //Post
        case 0:
            getVideojuegos({}).then(videojuegos => {
